...
public class ModBlocks {
    public static final Block CABBAGE_CROP_BLOCK = new CabbageCropBlock(FabricBlockSettings.copy(Blocks.WHEAT));
    public static final Block CILANTRO_CROP_BLOCK = new CabbageCropBlock(FabricBlockSettings.copy(Blocks.WHEAT));
    public static final Block CORN_CROP_BLOCK = new CabbageCropBlock(FabricBlockSettings.copy(Blocks.WHEAT));
    public static final Block MICROGREENS_CROP_BLOCK = new CabbageCropBlock(FabricBlockSettings.copy(Blocks.WHEAT));
    public static final Block PARSLEY_CROP_BLOCK = new CabbageCropBlock(FabricBlockSettings.copy(Blocks.WHEAT));
    public static final Block RICE_CROP_BLOCK = new CabbageCropBlock(FabricBlockSettings.copy(Blocks.WHEAT));
    public static final Block TOMATO_CROP_BLOCK = new CabbageCropBlock(FabricBlockSettings.copy(Blocks.WHEAT));
    public static final Block TURNIP_CROP_BLOCK = new CabbageCropBlock(FabricBlockSettings.copy(Blocks.POTATOES));
